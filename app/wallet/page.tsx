  ...
  return (
    <ProtectedRoute>
      ...
      <div className="relative min-h-screen w-full overflow-hidden pt-24 sm:pt-28">
        ...
        />
        {/* Main Content Area */}
        <div className="relative z-10 flex items-start justify-center min-h-[calc(100vh-100px)] p-3 sm:p-4 md:p-6">
          <div className="flex flex-col gap-4 sm:gap-6 w-full max-w-2xl">
            <div className="bg-green-100/90 border-2 sm:border-4 border-green-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-2xl w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <GameButton onClick={() => setShowSavedBanks(true)} className="w-full min-h-12">Saved bank details</GameButton>
                <GameButton onClick={() => setShowLinkModal(true)} className="w-full min-h-12">Link account</GameButton>
              </div>
            </div>
